# Guillaume Lemonnier - Portfolio Professionnel
...
- Serveur local optionnel (Live Server, Python HTTP server)
...
git clone https://github.com/P-Pix/P-Pix.github.io.git
cd P-Pix.github.io
...
- `src/css/style.css` : Styles globaux avec variables CSS
- `src/js/script.js` : Interactions JavaScript
- `src/html/` : Pages spécialisées et expertise
- `assets/` : Images et ressources media
...
- ⚖️ **Conditions d'usage** clairement définies
- 🔗 **Liens de licence** dans tous les footers

### Utilisation Responsable
- ✅ Consultation libre pour apprentissage
- ✅ Inspiration pour vos projets personnels
- ❌ Copie directe sans attribution
...
- Netlify (fonctionnalités avancées)
- Vercel (optimisé pour frameworks)
...
**v3.0** (Janvier 2025) - **Version Actuelle**
- ✅ 9 pages d'expertise spécialisées
- ✅ 40+ projets GitHub authentiques intégrés
- ✅ Protection licence complète
- ✅ Design professionnel finalisé

**v2.0** (Décembre 2024)
- ✅ Refonte complète du design
- ✅ Ajout section projets détaillée
- ✅ CV interactif avec timeline
- ✅ Optimisation mobile
...
- JavaScript ES6+ avec documentation
...
- [VS Code](https://code.visualstudio.com/) avec extensions recommandées
- [Chrome DevTools](https://developers.google.com/web/tools/chrome-devtools)
- [Lighthouse](https://developers.google.com/web/tools/lighthouse) pour l'audit
- [Wave](https://wave.webaim.org/) pour l'accessibilité

### Inspiration Design
- [Dribbble](https://dribbble.com/) - Inspiration graphique
- [Behance](https://www.behance.net/) - Portfolios créatifs
- [Awwwards](https://www.awwwards.com/) - Best practices web
